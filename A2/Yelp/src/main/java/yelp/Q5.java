...
import yelp.Q5.TopNMapper;
import yelp.Q5.TopNReducer;
...
public class Q5 {
    ...
    public static class TopNMapper extends Mapper<Object, Text, Text, IntWritable> {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
			...
			String business_id = businessData[2];
			String rate = businessData[3];
			context.write(new Text(business_id), new IntWritable(Integer.parseInt(rate)));
        }
    }
     ...
     */
    public static class TopNReducer extends Reducer<Text, IntWritable, Text, DoubleWritable> {
