...
val data = spark.read.format("libsvm").load("/FileStore/tables/0g8s1g5r1490407313484/rst.data")
...
val accuracy1 = evaluator1.evaluate(predictions)

println("second or = " + (1.0 - accuracy1))
